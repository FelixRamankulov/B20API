...
//        }
    ...
    public void productTest() {
        ...
        ProductPojo deserializedResponse = response.as(ProductPojo.class);
        System.out.println(deserializedResponse.getId());
        System.out.println(deserializedResponse.getCategory());
        System.out.println(deserializedResponse.getDescription());
        System.out.println(deserializedResponse.getTitle());
        System.out.println(deserializedResponse.getImage());

        System.out.println(deserializedResponse.getRating().getCount());
        System.out.println(deserializedResponse.getRating().getRate());
    ...
    public void pokemon() {
        ...
        List<ResultsPojo> results = deserializedResponse.getResults();

        for (int i = 0; i < results.size(); i++) {
            ResultsPojo temp = results.get(i);
    ...
    public void pokeapi() {
        ...
        List<PokeapiResultsPojo> results = deserializedResponse.getResults();

        for (int i = 0; i < results.size(); i++) {
            PokeapiResultsPojo temp = results.get(i);
